...
describe('Pruebas del servicio getIngresos', () => {
    let server;
    ...
    beforeEach(async () => {
        ...
        // Inserta ingresos de prueba relacionados con el usuario
    ...
    it('Debe devolver todos los ingresos correctamente', async () => {
        // Realiza la solicitud GET para obtener todos los ingresos
        const response = await supertest(server).get('/api/ingresos');
        ...
        // Verifica los campos de los ingresos
        response.body.forEach(ingreso => {
            expect(ingreso).to.include.keys('id_ingreso', 'id_usuario', 'monto', 'metodo', 'fecha');
        });
    });
